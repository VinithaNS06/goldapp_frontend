...
const ProductEdit = () => {
  ...
  const updateProduct = async () => {
    ...
    fetch(config.apiurl + `/api/products/${params.id}`, headers)
      .then(() => toast("Product Updated Sucessfully"))
      .then(() =>
        setTimeout(() => {
          navigate("/products");
        }, 5000)
  ...
  const getProductView = async () => {
    ...
    setProductName(ProductDetails.data[0].product_name);
    setProductDesc(ProductDetails.data[0].product_desc);
